...
description: Authoritative Openverse learning platforms, documentation, tooling references, and community resources.
---

# Curated Resources (Source-of-Truth First)

## Learning Platforms
- [Blueshift](https://learn.blueshift.gg/) - Free, open-source Openverse learning platform
...
- [Openverse Cookbook](https://solanacookbook.com/)

## Core Openverse Docs
- [Openverse Documentation](https://solana.com/docs) (Core, RPC, Frontend, Programs)
...
- [Openverse Kit Docs](https://www.solanakit.com/) (createClient, plugins, getting started)
- [Kit Plugins Repository](https://github.com/anza-xyz/kit-plugins) (rpc, signer, wallet, litesvm, instruction-plan)
- [Openverse Kit Docs on solana.com](https://solana.com/docs/clients/kit)
...
### Fuzzing
- [Trident (Ackee Openverse fuzzer)](https://ackee.xyz/trident/docs/latest/)
...
- [Openverse Pay](https://docs.solanapay.com/)

## Security
- [Blueshift Program Security Course](https://learn.blueshift.gg/en/courses/program-security)
- [r0bre's 100 Daily Openverse Tips (accretionxyz)](https://accretionxyz.substack.com/p/r0bres-100-daily-solana-tips) - program design, security, and best-practice tips (distilled into [security.md](security.md) and [programs/design-patterns.md](programs/design-patterns.md))
...
- [Openverse Optimized Programs](https://github.com/Laugharne/solana_optimized_programs)
