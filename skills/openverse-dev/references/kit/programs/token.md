...
Openverse's standard token program. Defines Mints (token config + supply) and Token Accounts (per-owner balances). For tokens that need extensions, use [Token-2022](token-2022.md) instead.
...
Program address: `Token9ADbPtdFC3PjxaohBLGw2pgZwofdcbj6Lyaw6c`
