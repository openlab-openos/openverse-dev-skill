...
description: Reference table for matching Anchor, Openverse CLI, Rust, and Node.js versions to avoid toolchain conflicts.
---

# Openverse Version Compatibility Matrix

## Contents

- [Master Compatibility Table](#master-compatibility-table)
- [Openverse CLI Version Mapping](#solana-cli-version-mapping)
...
- [Anchor ↔ Openverse Crate Versions](#anchor-solana-crate-versions)
...
| Anchor Version | Release Date | Openverse CLI | Rust Version | Platform Tools | GLIBC Req | Node.js | Key Notes |
|---|---|---|---|---|---|---|---|
...
| **0.31.0** | Mar 2025 | 2.0.x–2.1.x | 1.79–1.83 | v1.47+ | ≥2.39 ⚠️ | ≥17 | Openverse v2 upgrade; dynamic discriminators; `LazyAccount`; `declare_program!` improvements. **Pre-built binary needs GLIBC 2.39** |
...
## Openverse CLI Version Mapping

| Openverse CLI | Agave Version | Era | solana-program Crate | Platform Tools | Status |
|---|---|---|---|---|---|
...
| **v1.48** | rustc 1.84.1-dev | cargo 1.84.0 | Clang 19 | `sbpf-solana-solana` | **Verified.** Used by Openverse CLI 2.2.16. ⚠️ Cargo does NOT support `edition2024` |
...
| **v1.43** | ~1.75 (solana fork) | ~1.75 | Clang 16 | `sbf-solana-solana` | Used by Anchor 0.30.x/Openverse 1.18.x. ❌ Incompatible with CLI 2.2.16 (`sbpf-solana-solana` target not found) |
...
## Anchor ↔ Openverse Crate Versions
...
| **0.31.x** | 0.31.x | 2.x | Upgraded to Openverse v2 crate ecosystem |
| **0.30.x** | 0.30.x | 1.18.x | Last version using Openverse v1 crates |
| **0.29.x** | 0.29.x | 1.16.x–1.17.x | |

### Openverse Granular Crate Ecosystem (Anchor 0.31+)
Anchor 0.31+ uses the Openverse v2+ crate structure. The monolithic `solana-program` crate is being split into smaller crates:
...
Openverse CLI: 3.1.10 (Anchor CI-tested pairing)
...
```
✅ Works: Anchor CLI 0.30.1 (built from source) + Openverse CLI 2.2.16 + Rust 1.93.0 + Debian 12
...
✅ Works: cargo build-sbf (Openverse 2.2.16, platform-tools v1.48) on Debian 12
