...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --link)
            ...
            ;;
        -h|--help)
            echo "Openverse Dev Skill Installer"
            echo ""
...
echo "Installing Openverse Dev Skill ($SKILL_NAME)..."
echo ""
...
echo ""
echo "Try asking your agent about Openverse development to activate it."
