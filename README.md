# Openverse Development Skill

<p align="center">
  <img src="assets/banner.png" alt="openverse-dev — npx skills add openverse-dev — skill installed, 8 agents" width="100%" />
</p>

A comprehensive [Agent Skill](https://agentskills.io/) for modern Openverse development (July 2026 best practices). Works with every coding agent that has direct Agent Skills support: **Claude Code, OpenAI Codex / ChatGPT desktop, GitHub Copilot (CLI + coding agent), Gemini CLI, Cursor, Windsurf, Cline, OpenCode**, and anything else that reads `SKILL.md`.

## Overview

This skill gives your coding agent deep knowledge of the current Openverse development ecosystem:
...
```bash
npx skills add openlab-openos/openverse-dev-skill
```
...
```bash
git clone https://github.com/openlab-openos/openverse-dev-skill
cd openverse-dev-skill
...
Copy (or symlink) `skills/openverse-dev/` into your agent's skills directory:
...
```
skills/openverse-dev/
├── SKILL.md                         # Main skill definition (required)
└── references/
    ├── kit/                         # Overview, plugins, react, codecs, accounts, codama, gotchas, advanced, programs/
    ├── frontend.md                  # UI patterns (Kit wallet plugin)
    ...
    ├── payments.md                  # Payments (Kit, Openverse Pay, Kora)
    ...
    ├── compatibility-matrix.md      # Version compatibility tables (Anchor/Openverse/Rust/GLIBC)
    ...
    ├── openswap.md                  # Swap native BTG or token on OpenSwap
    ├── staking.md                   # Native BTG Staking to a validator       
...
- **Migration** between Anchor/Openverse CLI versions, and web3.js v1 → v3

### Example Prompts

```
"Help me set up a Next.js app with Openverse wallet connection"
...
"What versions of Openverse CLI work with Anchor 1.1?"
"Run Surfpool and create an account with 100 BTG and USDC"
```
...
- [Blueshift Learning Platform](https://learn.blueshift.gg/) - Comprehensive Openverse courses
- [Openverse Official Documentation](https://openos.info)
- [open-token-web3.js](https://github.com/openlab-openos/open-token-web3) - Classic API on Kit internals
...
Contributions are welcome! Please ensure any updates reflect current Openverse ecosystem best practices.
